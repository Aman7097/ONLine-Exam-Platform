  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#" data-toggle="modal" data-target="#login">HEAD</a></li>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><span style="color:#3498DB;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>LOGIN -ADMIN</b></span></h4>
      </div>
...
<div class="modal fade" id="login2">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title"><span style="color:#583d50;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>LOGIN -TEACHER</b></span></h4>
      </div>
      <div class="modal-body title1">
<div class="row">
<div class="col-md-3"></div>
...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      ...
      <div class="col-sm-4">
      <div class="thumbnail" style="background-color: beige;">
        <p><strong>Aman Singh</strong></p>
        <p>B.B.S.B.E.C 7th sem</p>
        <p>170280208</p>
      </div>
      </div>
      <div class="col-sm-4">
  ...
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>"Very good iniative. I am so happy with the result!"<br><span>Michael Roe, Head of Department</span></h4>
      </div>
      <div class="item">
        <h4>"One word... WOW!!"<br><span>Joey Tribbiani, Teacher</span></h4>
      </div>
      <div class="item">
        <h4>"Could I... BE any more happy with this startup"<br><span>Chandler Bing, Friend</span></h4>
      </div>
    </div>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-map-marker"></span Fatehgarh_sahib,Punjab, INDIA</p>
      <p><span class="glyphicon glyphicon-phone"></span> +91 7986348681 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> amandeeppos@gmail.com</p>
    </div>
